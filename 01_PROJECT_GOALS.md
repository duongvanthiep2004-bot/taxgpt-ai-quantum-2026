...
- **Giới hạn Case 3 sau alignment:** Rule chưa kiểm tra `total_amount = taxable_amount + vat_amount`, chưa xử lý đầy đủ ngoại lệ làm tròn/nhiều dòng/chiết khấu; legal review vẫn `Pending`, chưa được rà soát độc lập và RAG vẫn **LOCKED toàn bộ 5 case**.
