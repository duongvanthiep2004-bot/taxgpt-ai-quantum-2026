...
### P1 — Upload file thật cho Excel hóa đơn và payment
...
### P2 — Cải thiện dashboard mức vừa
...
### P3 — Hỏi Khánh về tiến độ kiểm chứng pháp lý

- Xác nhận phần đã đối chiếu, phần còn thiếu và thời điểm dự kiến hoàn thành.
- Khi có kết quả, tiếp tục dùng Gemini Pro hỗ trợ đối chiếu nguồn, hiệu lực và điều/khoản; Khánh/con người chốt.
...
**Bước đầu phiên sau:** thực hiện P1 — thiết kế luồng upload file Excel hóa đơn và payment, kèm kiểm tra schema và lỗi đầu vào.
